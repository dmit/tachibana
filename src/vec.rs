...
impl Vec3 {
    ...
    #[inline]
    pub fn unit(self) -> Vec3 { self / self.length() }

    #[inline]
    pub fn dot(&self, a: Vec3) -> f32 { self.x * a.x + self.y * a.y + self.z * a.z }
...
impl Add<Vec3> for Vec3 {
    ...
    fn add(self, a: Vec3) -> Self::Output {
        Vec3 { x: self.x + a.x, y: self.y + a.y, z: self.z + a.z }
    }
}
...
impl Neg for Vec3 {
    ...
    #[inline]
    fn neg(self) -> Self::Output { Vec3 { x: -self.x, y: -self.y, z: -self.z } }
}
...
impl Mul<f32> for Vec3 {
    ...
    #[inline]
    fn mul(self, a: f32) -> Self::Output { Vec3 { x: self.x * a, y: self.y * a, z: self.z * a } }
}
...
impl Div<f32> for Vec3 {
    ...
    #[inline]
    fn div(self, a: f32) -> Self::Output { Vec3 { x: self.x / a, y: self.y / a, z: self.z / a } }
}
